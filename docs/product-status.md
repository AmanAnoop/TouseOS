...
Last updated: Wave 23 on `cursor/wave23-social-profile-apis-4a50`.
...
| **Connected user journeys** | **~77%** | Social albums/photos APIs; profile and account scoped to active org |
