...
export function SportsTripDetail({ tripId }: SportsTripDetailProps) {
  ...
  if (!trip) {
    return (
      <EmptyState title="Trip not found" action={<Link href="/travel">Back to travel</Link>} />
    );
  }
  ...
  return (
    <div className="ds-page-stack">
      ...
      <Modal open={calcOpen} onClose={() => setCalcOpen(false)} title="Save trip budget" size="lg"
        footer={<><Button variant="secondary" onClick={() => setCalcOpen(false)}>Cancel</Button><Button onClick={saveCosts}>Save to trip</Button></>}
      >
